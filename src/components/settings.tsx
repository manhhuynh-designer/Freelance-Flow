...
const predefinedThemes: { name: string; colors: ThemeSettings }[] = [
    { name: 'Default', colors: { primary: "180 100% 25.1%", accent: "120 61% 33.9%" } },
...
export default function SettingsPage() {
    ...
    const { 
        appSettings, setAppSettings, handleClearAllData, 
        tasks, quotes, collaboratorQuotes, clients, collaborators, quoteTemplates, categories,
        ...rest
    } = dashboardContext;
    ...
    const handleConfirmRestore = () => {
        if (restoredData) {
            const {setTasks, setQuotes, setCollaboratorQuotes, setClients, setCollaborators, setQuoteTemplates, setCategories, setAppSettings} = rest;
            ...
            setAppSettings(restoredData.appSettings || defaultSettings);
