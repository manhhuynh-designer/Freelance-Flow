export const vi_base = {
  ...
  ,briefLink: 'Brief'
  ,driveLink: 'Lưu trữ'
  ,quoteValidityNote: 'Giá trị báo giá tồn tại trong 30 ngày kể từ ngày cấp. Vui lòng liên hệ chúng tôi nếu bạn có bất kỳ câu hỏi nào.'
  ,quoteValidityNoteDesc: 'Tùy chỉnh văn bản ghi chú hiệu lực hiển thị trên báo giá và trang chia sẻ'
  ,showValidityNote: 'Hiển thị ghi chú hiệu lực'
  ,showValidityNoteByDefault: 'Hiển thị theo mặc định khi chia sẻ'
  ,linksDisplay: 'Hiển thị liên kết'
  ,showBriefLinks: 'Hiển thị Brief Links'
  ,showDriveLinks: 'Hiển thị Drive Links'
