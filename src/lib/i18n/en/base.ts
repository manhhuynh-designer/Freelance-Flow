export const en_base = {
  ...
  ,quoteValidityNoteDesc: 'Customize the validity note text shown on quotes and share pages'
  ,showValidityNote: 'Show validity note'
  ,showValidityNoteByDefault: 'Show by default when sharing'
  ,linksDisplay: 'Links Display'
  ,showBriefLinks: 'Show Brief Links'
  ,showDriveLinks: 'Show Drive Links'
